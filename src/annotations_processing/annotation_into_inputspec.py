...
from src.annotations_processing.brat_parser import parse_brat_file, get_polirep_per_policy_from_annotation
from src.annotations_processing.formal_structs import InputSpec


def annotation_into_inputspec(policy_path):
    inputspecs = []

    _, entities, relations = get_polirep_per_policy_from_annotation(policy_path)
